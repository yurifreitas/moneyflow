        ...
        <>
            <div style={{padding: 20}}>
                ...
                {currency ? Object.keys(currency).map((item, i) => (
                    ...
                    <Card
                        border={currency[item].variation == 0 ? "primary" : currency[item].variation > 0 ? "success" : "danger"}
                        className="mb-4 text-center" key={i}>
                        ...
                        <Card.Body>
                            ...
                            <Row className="justify-content-center">
                                <span
                                    className={"input-label " + (currency[item].variation == 0 ? "text-primary" : currency[item].variation < 0 ? "text-danger" : "text-success")}> {currency[item].variation}%</span>
                            </Row>
                        </Card.Body>
                        <Link to={"/currency/" + item}
                              className={"btn " + (currency[item].variation == 0 ? "btn-primary" : currency[item].variation > 0 ? "btn-success" : "btn-danger") + " w-100 mt-3"}>ver
                            mais</Link>
                    </Card>
            ...
            <div style={{padding: 20}}>
                ...
                {stock ? Object.keys(stock).map((item, i) => (
                    ...
                    <Card
                        border={stock[item].variation == 0 ? "primary" : stock[item].variation > 0 ? "success" : "danger"}
                        className="mb-4 text-center" key={i}>
                        ...
                        <Card.Body>
                            ...
                            <Row className="justify-content-center">
                                <span
                                    className={"input-label " + (stock[item].variation < 0 ? "text-danger" : "text-success")}> {stock[item].variation}%</span>
                            </Row>
                        </Card.Body>
                        <Link to={"/stock/" + item}
                              className={"btn " + (stock[item].variation > 0 ? "btn-success" : "btn-danger") + " w-100 mt-3"}>ver
                            mais</Link>
                    </Card>
